...
const HEAVYMETA: Symbol = symbol_short!("TEST");
...
mod pintheon_node_token {
    soroban_sdk::contractimport!(
        file = "../pintheon-node-deployer/pintheon-node-token/target/wasm32v1-none/release/pintheon_node_token_v0.0.6.wasm"
    );
}

mod pintheon_ipfs_token {
    soroban_sdk::contractimport!(
        file = "../pintheon-ipfs-deployer/pintheon-ipfs-token/target/wasm32v1-none/release/pintheon_ipfs_token_v0.0.6.wasm"
    );
}

mod opus_token {
    soroban_sdk::contractimport!(
        file = "../opus_token/target/wasm32v1-none/release/opus_token_v0.0.6.wasm"
    );
}
